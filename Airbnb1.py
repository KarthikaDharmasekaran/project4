...
with col1:
       st.image('airbnb image.jpg')
        
with col2:
    col2.subheader("NAME : D.KARTHIKA")
    col2.subheader("BATCH : DW77DW78")
    col2.subheader("MAIL : KARTHIKAXXXX@GMAIL.COM")